  ...
  return (
    <div className={`relative flex flex-col items-center justify-center text-center select-none w-full max-w-full ${className}`}>
      <div className="relative inline-block px-1 sm:px-2 max-w-full overflow-hidden">
        <h1
          id="hero-wordmark"
          className="text-[#57391F] font-bold uppercase leading-[0.9] whitespace-nowrap transition-all duration-700"
          style={{
      ...
      {subtitle && (
        <div className="mt-6 sm:mt-8 flex flex-col items-center gap-3 w-full max-w-xl px-4">
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 text-[9px] sm:text-xs tracking-[0.22em] text-[#806345] font-serif uppercase">
